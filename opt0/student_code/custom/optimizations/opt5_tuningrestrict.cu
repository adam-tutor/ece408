...
__global__ void conv_forward_kernel(float* __restrict__ output, const float* __restrict__ input, const float* __restrict__ mask, const int B, const int M, const int C, const int H, const int W, const int K,const int S)
{
    ...
    */
    ...
    if(h < H_out && w < W_out){
        for(int c = 0; c < C; c++){
            if(K == 1){
                value +=  in_4d(b, c, h * S + 0, w * S + 0) * mask_4d(m, c, 0, 0);
            }
            if(K == 2){
                value +=  in_4d(b, c, h * S + 0, w * S + 0) * mask_4d(m, c, 0, 0)
                    + in_4d(b, c, h * S + 0, w * S + 1) * mask_4d(m, c, 0, 1)
                    + in_4d(b, c, h * S + 1, w * S + 0) * mask_4d(m, c, 1, 0)
                    + in_4d(b, c, h * S + 1, w * S + 1) * mask_4d(m, c, 1, 1);
            }
            if(K == 3){
                value +=  in_4d(b, c, h * S + 0, w * S + 0) * mask_4d(m, c, 0, 0)
                    + in_4d(b, c, h * S + 0, w * S + 1) * mask_4d(m, c, 0, 1)
                    + in_4d(b, c, h * S + 0, w * S + 2) * mask_4d(m, c, 0, 2)
                    + in_4d(b, c, h * S + 1, w * S + 0) * mask_4d(m, c, 1, 0)
                    + in_4d(b, c, h * S + 1, w * S + 1) * mask_4d(m, c, 1, 1)
                    + in_4d(b, c, h * S + 1, w * S + 2) * mask_4d(m, c, 1, 2)
                    + in_4d(b, c, h * S + 2, w * S + 0) * mask_4d(m, c, 2, 0)
            ...
            if(K == 4){
                value +=  in_4d(b, c, h * S + 0, w * S + 0) * mask_4d(m, c, 0, 0)
                    + in_4d(b, c, h * S + 0, w * S + 1) * mask_4d(m, c, 0, 1)
                    + in_4d(b, c, h * S + 0, w * S + 2) * mask_4d(m, c, 0, 2)
                    + in_4d(b, c, h * S + 0, w * S + 3) * mask_4d(m, c, 0, 3)
                    + in_4d(b, c, h * S + 1, w * S + 0) * mask_4d(m, c, 1, 0)
                    + in_4d(b, c, h * S + 1, w * S + 1) * mask_4d(m, c, 1, 1)
                    + in_4d(b, c, h * S + 1, w * S + 2) * mask_4d(m, c, 1, 2)
                    ...
                    + in_4d(b, c, h * S + 3, w * S + 0) * mask_4d(m, c, 3, 0)
            ...
            if(K == 5){
                value +=  in_4d(b, c, h * S + 0, w * S + 0) * mask_4d(m, c, 0, 0)
                    ...
                    + in_4d(b, c, h * S + 0, w * S + 2) * mask_4d(m, c, 0, 2)
                    + in_4d(b, c, h * S + 0, w * S + 3) * mask_4d(m, c, 0, 3)
                    + in_4d(b, c, h * S + 0, w * S + 4) * mask_4d(m, c, 0, 4)
                    + in_4d(b, c, h * S + 1, w * S + 0) * mask_4d(m, c, 1, 0)
                    + in_4d(b, c, h * S + 1, w * S + 1) * mask_4d(m, c, 1, 1)
                    + in_4d(b, c, h * S + 1, w * S + 2) * mask_4d(m, c, 1, 2)
                    + in_4d(b, c, h * S + 1, w * S + 3) * mask_4d(m, c, 1, 3)
                    ...
                    + in_4d(b, c, h * S + 4, w * S + 0) * mask_4d(m, c, 4, 0)
            ...
            if(K == 6){
                value +=  in_4d(b, c, h * S + 0, w * S + 0) * mask_4d(m, c, 0, 0)
                    ...
                    + in_4d(b, c, h * S + 0, w * S + 3) * mask_4d(m, c, 0, 3)
                    + in_4d(b, c, h * S + 0, w * S + 4) * mask_4d(m, c, 0, 4)
                    + in_4d(b, c, h * S + 0, w * S + 5) * mask_4d(m, c, 0, 5)
                    + in_4d(b, c, h * S + 1, w * S + 0) * mask_4d(m, c, 1, 0)
                    + in_4d(b, c, h * S + 1, w * S + 1) * mask_4d(m, c, 1, 1)
                    + in_4d(b, c, h * S + 1, w * S + 2) * mask_4d(m, c, 1, 2)
                    + in_4d(b, c, h * S + 1, w * S + 3) * mask_4d(m, c, 1, 3)
                    ...
                    + in_4d(b, c, h * S + 5, w * S + 0) * mask_4d(m, c, 5, 0)
            ...
            if(K == 7){
                value +=  in_4d(b, c, h * S + 0, w * S + 0) * mask_4d(m, c, 0, 0)
                    ...
                    + in_4d(b, c, h * S + 0, w * S + 4) * mask_4d(m, c, 0, 4)
                    + in_4d(b, c, h * S + 0, w * S + 5) * mask_4d(m, c, 0, 5)
                    + in_4d(b, c, h * S + 0, w * S + 6) * mask_4d(m, c, 0, 6)
                    ...
                    + in_4d(b, c, h * S + 6, w * S + 0) * mask_4d(m, c, 6, 0)
